;; Borrowed from https://github.com/chrismgray/clojure-heap-sort
;; Used because it provides a lazy seq version of sort, allowing reccomendations to only use the data they need and no more

(ns simple-recommendations.heap-sort)
...
(defn heap-sort-by
  "Returns a lazy sorted sequence of the items in coll, where the sort
  ...
  ([keyfn ^java.util.Comparator comp coll]
   (heap-sort (fn [x y] (. comp (compare (keyfn x) (keyfn y)))) coll)))
